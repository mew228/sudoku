...
const listenToConnection = (callback)=>{
    const connectedRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$node$2d$esm$2f$index$2e$node$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ref"])(getDb(), ".info/connected");
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$node$2d$esm$2f$index$2e$node$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["onValue"])(connectedRef, (snap)=>{
...
const subscribeToBoard = (roomId, callback)=>{
    const boardRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$node$2d$esm$2f$index$2e$node$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ref"])(getDb(), `rooms/${roomId}/board`);
...
const useGameStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        ...
        setCellValue: (num)=>{
            ...
            if (isCorrect) {
                ...
                if (mode === 'pvp' && roomId) {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$rooms$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateBoardCell"])(roomId, r, c, num).catch((e)=>{
                    ...
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$rooms$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateProgress"])(roomId, progress, mistakes, isWon ? 'won' : 'playing').catch((e)=>{
                ...
                if (mode === 'pvp' && roomId) {
                    ...
                    const progress = Math.floor(filled / (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logic$2f$sudoku$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["GRID_SIZE"] * __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logic$2f$sudoku$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["GRID_SIZE"]) * 100);
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$rooms$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateProgress"])(roomId, progress, newMistakes, isLost ? 'lost' : 'playing').catch((e)=>{
...
;
const PvPArena = ()=>{
    const { difficulty, status, opponentName, opponentProgress, mistakes, mode, opponentStatus, roomId, playerId, uid, isFirebaseConnected, lastSyncError, setMultiplayerState } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useGameStore"])();
...
function Home() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        // Connection Listener
        const unsubConn = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$rooms$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["listenToConnection"])((connected)=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useGameStore"].setState({
