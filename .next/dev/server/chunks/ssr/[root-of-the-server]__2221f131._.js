...
const useGameStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        ...
        setCellValue: (num)=>{
            ...
            if (isWon) {
                ...
                setTimeout(()=>{
                    __turbopack_context__.A("[project]/lib/firebase/leaderboard.ts [app-ssr] (ecmascript, async loader)").then(({ addScore })=>{
...
const PvPArena = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$rooms$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["subscribeToRoom"])(roomId, (room)=>{
            // Find opponent
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2221f131._.js.map